"""Dispatch exactly one previously persisted pending philosopher-post attempt."""
...
from wiki_philosopher_bot.posting_outbox import dispatch_posting_attempt
...
def parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description="Send exactly one stored pending philosopher-post attempt."
    )
...
def main(argv=None):
    ...
    result = dispatch_posting_attempt(
        database=database,
